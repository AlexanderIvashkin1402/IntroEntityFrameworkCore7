...
namespace TaskManager
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            var statuses = tmContext.Status.ToList();
        ...
        private void cmdSelection_Changed(object sender, EventArgs e)
        {
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                txtTask.Text = t.Name;
                cboStatus.Text = t.Status.Name;
                if (t.DueDate.HasValue) dateTimePicker1.Value = t.DueDate.Value;
            }
        }
    }
}
